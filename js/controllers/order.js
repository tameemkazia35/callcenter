...
$(document).on("click", ".logout", function (e) {
    ...
    webpos.RefreshTable(window.localStorage.getItem("BranchID"), window.localStorage.getItem("orderNo"), function (sObj) {
        console.log(sObj);
        localStorage.clear();
        window.location = "/../"; 
...
/* Load Order Items */
fnLoadOrderItems = function (_branchId, _orderId) {
    $.ajax({
        url: '../webpos.asmx/GetOrderItemsList',
        cache: true,
        method: 'post',
        data: '{ "BranchID": ' + _branchId + ' , "OrderID": ' + _orderId + ' }',
...
fnLoadOrderItems(localStorage.getItem("BranchID"), localStorage.getItem("orderId"));
...
fnLoadGroupList = function (screenId, type) {
    $.ajax({
        ...
        cache: true,
        method: 'post',
        data: '{ "BranchID": ' + localStorage.getItem("BranchID") + ', "ScreenID": ' + screenId + ', "Type": ' + type + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function (e, d) {
    ...
    switch (itemType) {
        ...
        case 1:
            ...
            if ($(this).text().indexOf("***") == -1 && $(this).data("price") != 0) {
                ...
                webpos.GetItemsFromSetMenu(_curItemId, 1, function (_response) {
                ...
                if ($(this).data("modifier1") != null) {
                    ...
                    $.ajax({
                        ...
                        cache: true,
                        method: 'post',
                        data: '{"ModifierID": ' + $(this).data("modifier1") + '}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        beforeSend: function (e, d) {
                ...
                if ($(this).data("modifier2") != null) {
                    ...
                    $.ajax({
                        ...
                        cache: true,
                        method: 'post',
                        data: '{"ModifierID": ' + $(this).data("modifier2") + '}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        beforeSend: function (e, d) {
                            /* $("#itemsList").html("<i class='fa fa-spinner fa-spin'></i>");
                ...
                if ($(this).data("modifier3") != null) {
                    ...
                    $.ajax({
                        ...
                        cache: true,
                        method: 'post',
                        data: '{"ModifierID": ' + $(this).data("modifier3") + '}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        beforeSend: function (e, d) {
                ...
                if ($(this).data("modifier4") != null) {
                    ...
                    $.ajax({
                        ...
                        cache: true,
                        method: 'post',
                        data: '{"ModifierID": ' + $(this).data("modifier4") + '}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        beforeSend: function (e, d) {
                        },
...
$("#btnOrder").click(function () {
    ...
    webpos.PrintKitchenOrder(_bId, _wsId, _empNo, _orderId, _orderNo, _noGuest, SelectedItems, function (sObj) {
        $(".preloader").fadeIn();
        if (sObj) {
    ...
    /* $.ajax({
    url: '../webpos.asmx/PrintKitchenOrder',
    method: 'post',
    ...
    console.log(response.responseJSON.d);
    } else {
    alert(response);
    }
    }
...
$("#btnPrint").click(function () {
    ...
    webpos.PrintInvoice(_bId, _wsId, _orderType, _orderId, _closedBy, _orderNo, _noGuest, _totalPrice, SelectedItems, function (sObj) {
        $(".preloader").fadeIn();
        if (sObj) {
            window.location = "../dashboard"
        }
    ...
    /*
    $.ajax({
    url: '../webpos.asmx/PrintInvoice',
    method: 'post',
    data: '{"BranchID":  ' + window.localStorage.getItem("BranchID") + ', "ws": ' + $("#wsList").val() + ', "OrderID": ' + window.localStorage.getItem("orderId") + '}',
    contentType: "application/json; charset=utf-8",
    dataType: "json",
    beforeSend: function (e, d) {
...
$(".btn-home").click(function () {
    ...
    if ($("table.items tbody tr.old").length == 0) {
        /*delete order*/
        webpos.DeleteOrder(window.localStorage.getItem("orderId"), function (sObj) { window.location = "../dashboard"; }, function (fObj) { conosle.log(fObj) });
    }
    /*Unlock*/
    webpos.RefreshTable(window.localStorage.getItem("BranchID"), window.localStorage.getItem("orderNo"), function (sObj) { console.log(sObj); }, function (fObj) { console.log(fObj); })
    window.location = "../dashboard";
    return false;
});
