...
//---------------------- method to render data on to the table -------------------------------------------------------
        ...
        function fnBindTableData(_tbdData) {
           ...
           var tFooter = '<tr><td colspan="3" class="text-right">Total Amount: </td><td class="text-right"><strong>' + sum.toFixed(2) + '</td><td colspan="2"></td></tr>';
           tFooter += '<tr><td colspan="3" class="text-right">Total Orders: </td><td class="text-right"><strong>' + counter + '</strong></td><td colspan="2"></td></tr>';
